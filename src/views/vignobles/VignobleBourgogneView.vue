<template>
    <div>
        <h1 class=" text-center text-2xl">Le vignoble de Bourgogne</h1>
        ...
        <div>
            ...
            <ul class=" list list-disc list-inside">
                <li><a href="#bourgogne">La Bourgogne, un vignoble unique et un terroir des meilleurs vins</a></li>
                <li><a href="#appelation">Les appellations des vins de Bourgogne</a></li>
        ...
        <div id="bourgogne" class="text-justify">
            ...
            <ul class="mt-2 list list-disc list-inside">
                ...
                <li>le Chardonnay pour les vins blancs</li>
            </ul>

            <h2 class="font-bold mt-5">Production viticole</h2>
            <p class="mt-2">
                1,5 millions d'hectolitres de vin produit par an, dont :
            </p>
            <ul class="mt-2 list list-disc list-inside">
        ...
        <div>
            ...
            <div class="flex justify-center">
                <div class=" grid grid-cols-2 mt-2">
                    ...
                    <RouterLink to="/vignoble/sud-ouest" title="Alsace">Vignoble d'Alsace</RouterLink>
