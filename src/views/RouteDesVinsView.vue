...
<div class="padCorp">
  ...
  <div>
    <div>
      <h2 class=" flex text-3xl mt-10 mb-10 text-center " id="title">Partir sur la Route des Vins</h2>
      ...
      <h2 class=" flex text-3xl mt-10 mb-10" id="title">Les Routes en France</h2>
        ...
        <div class="grid md:grid-cols-2 mt-5">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins d'Alsace</h4>
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins de Bourgogne</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins de Bordeaux</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins de Provence</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route du Champagne</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins du Val de Loire</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins du Languedoc-Roussillon</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins du Rhône</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins du Beaujolais</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins de Corse</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins du Sud-Ouest</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins du Jura</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins de la Savoie</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
          ...
          <div class="flex flex-col gap-1 mb-5 mx-3">
            <h4 class="flex text-2xl justify-center text-center">Route des vins d'Ile-de-France</h4>
            <div class="flex flex-col gap-4 mb-5 hover:-translate-y-1 transition ease-in-out shadow-2xl shadow-black rounded-lg pb-4">
