...
<template>
  <header id="top" class="w-full absolute top-0 z-50 md:px-10 px-4 md:pt-10 pt-5">
    <div class="flex w-full justify-between">
      <div class="flex items-center gap-8">
        ...
        <ul id="menu"
          class="gap-4 lg:flex hidden text-2xl text-white border-l-2 border-zinc-800 pl-8"
        >
          ...
          <li>
            <RouterLink to="/aide" class="flex items-center">
      ...
      <div class="flex text-2xl text-white items-center gap-3">
        ...
        <!-- Mobile menu -->
        <div ref="menuHamburger" @click="mobileMenu = !mobileMenu" title="menu" class="flex lg:hidden">
          <ion-icon class="text-5xl menuHamburger" name="menu-outline"></ion-icon>
        </div>
      </div>     
    </div>
    ...
    <div class="lg:hidden relative" >
      <ul id="menu"
          ...
          ref="mobMenHtml"
        >
          <li @click="mobileMenu = false" :class="useRoute().name == 'Séjour' ? 'text-rouge underline decoration-rouge decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-[0.5rem] focus:decoration-[0.5rem] hover:decoration-rouge focus:decoration-rouge': 'text-white'">
            <RouterLink to="/sejour">Séjour</RouterLink>
          </li>
          <li @click="mobileMenu = false" :class="useRoute().name == 'Vignoble' ? 'text-rouge underline decoration-rouge decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-[0.5rem] focus:decoration-[0.5rem] hover:decoration-rouge focus:decoration-rouge': 'text-white'">
            <RouterLink to="/vignoble">Vignoble</RouterLink></li>
          <li @click="mobileMenu = false" :class="useRoute().name == 'RouteDesVins' ? 'text-rouge underline decoration-rouge decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-[0.5rem] focus:decoration-[0.5rem] hover:decoration-rouge focus:decoration-rouge': 'text-white'">
            <RouterLink to="/route-des-vins">Route des vins</RouterLink></li>
          <li @click="mobileMenu = false" :class="useRoute().name == 'CoffretCadeau' ? 'text-rouge underline decoration-rouge decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-[0.5rem] focus:decoration-[0.5rem] hover:decoration-rouge focus:decoration-rouge': 'text-white'">
            <RouterLink to="/coffretCadeau">Cadeau</RouterLink></li>
          <li @click="mobileMenu = false" :class="useRoute().name == 'OffreEntreprise' ? 'text-rouge underline decoration-rouge decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-[0.5rem] focus:decoration-[0.5rem] hover:decoration-rouge focus:decoration-rouge': 'text-white'">
            <RouterLink to="/offreEntreprise">Offre entreprise</RouterLink></li>
          <li @click="mobileMenu = false" :class="useRoute().name == 'Contact' ? 'text-rouge underline decoration-rouge decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-[0.5rem] focus:decoration-[0.5rem] hover:decoration-rouge focus:decoration-rouge': 'text-white'">
            <RouterLink to="/contact">Contact</RouterLink></li>
        </ul>
    </div>
